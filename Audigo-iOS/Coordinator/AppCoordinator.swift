...
final class AppCoordinator: SceneCoordinatorType, HasDisposeBag {
    ...
    static func actualViewController(for viewController: UIViewController) -> UIViewController {
      if let tabbarController = viewController as? UITabBarController {
        guard let viewControllers = tabbarController.viewControllers else { return viewController }
        return actualViewController(for: viewControllers[tabbarController.selectedIndex])
